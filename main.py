...
def train_fn(
    disc, gen, loader, opt_disc, opt_gen, l1_loss, bce, ssim, KL, g_scaler, d_scaler,
):
    ...
    for idx, (x, y) in enumerate(loop):
        ...
        with torch.cuda.amp.autocast():
            ...
            G_loss = G_fake_loss + L1 + KL(y_fake.clone(),y.clone()) * 10
...
def main():
    ...
    for epoch in range(config.NUM_EPOCHS):
        train_fn(
            disc, gen, train_loader, opt_disc, opt_gen, L1_LOSS, BCE, ssim, KL, g_scaler, d_scaler,
        )
